...
// //                 className="absolute top-2 sm:top-3 right-2 sm:right-3  text-white p-1.5 sm:p-2 !rounded-full hover:bg-[#5E0208] transition shadow-lg"
// //               >
...
//                 type="button"
//                 onClick={removeThumbnail}
//                 className="absolute top-2 sm:top-3 right-2 sm:right-3  text-[#5E0208] p-1.5 sm:p-2 !rounded-full hover:bg-[#5E0208] hover:text-white transition shadow-lg"
//               >
//                 <X className="w-4 h-4 sm:w-5 sm:h-5" />
//               </button>
//             </div>
